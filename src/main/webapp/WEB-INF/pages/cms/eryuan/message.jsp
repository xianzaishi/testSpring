								...
								<tr>
									...
									<!-- 提问框 start -->
										<table width="100%">
											<tr>
												<td>
													<table height="500" cellSpacing="0" cellPadding="0" width="500"
														align="center" background="${contextPath}/images/eryuan/message.gif" border="0">
														<tbody>
															<tr>
																<td height="330"></td>
															</tr>
															<tr>
																<td vAlign="top">
																<div class="font14" align="center"><strong>您的问题已经提交，内容<font
																	color="#0099ff"></font><font color="#ff0000">审核中...<br/><br/>
																</font></strong><span class="font12"><font color="#666666"><a
																	href="${contextPath}/faq/page/1">点此返回</a></font></span></div>
																</td>
															</tr>
														</tbody>
													</table>
