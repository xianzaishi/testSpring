											...
											<c:forEach items="${contentList }" var="contentList">
												<tr>
													<td  width="560px">
														...
														<a href="${contextPath}/labor/union/content/detail/contentId/${contentList.id }" target="_blank"><font style="font-size: 10pt; color:black;"><c:out value="${contentList.title }"/></font></a>
													</td>
													<td align="right">
